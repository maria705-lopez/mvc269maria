          ...
          <div class="row w-100 mx-0">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                ...
                <h6 class="fw-light">Registrar los Productos es fácil. Sólo se necesitan unos pocos pasos</h6>
                <form class="pt-3"action="?controller=product&action=Register" method="post" id="frm" onsubmit="return false" enctype="multipart/form-data">
                ...
                <div class="form-group">
                <input type="file" class="form-control form-control-lg" id="photo" required>
                </div>
                <div class="mt-3 d-grid gap-2">
                   <input type="submit" value="Registrar" onclick="registerProduct()" class="btn btn-block btn-primary btn-lg fw-medium auth-form-btn">
                    
                  </div>
                  <div class="text-center mt-4 fw-light">
                   <a href="?controller=home&action=main" class="text-primary">Ir a la pagina principal</a>
                  </div>
                </form>
              </div>
            </div>
